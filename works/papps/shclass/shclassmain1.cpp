...
int Rin = 2,Hin = 1,Min = 1,Rhid = 2,Hhid = 1,Mhid = 1,Mout = 10,nstep = 1,ngap = 1,nepoc = 1,
    nutrpat = 10,nstrpat = 10,ntetrpat = nstrpat,ntepat = -1,flpscr = 1,
    verbosity = 3,logselect = 1,r0 = 0,nrow = -1,c0 = 0,ncol = -1;
long shseed = -1;
float inhidpdens = 1,inhidwdens = 1,hidagain = 1,inhidtaup = -1,inhidtaub = -1,hidcltaup = -1,
    hidbgain = -1,hidnmean = 0,hidnamp = 0,maxfq = 100,inhidpsilent = 0,pspa = 0,pspc = 0,
    kbjhalf = 0,kTp = 0.1,kTb = 0.1;
bool dolog = true;
string inactfn = "LIN",hidactfn = "BCP",datasetstr = "mnist";
...
int main(int argc,char **args) {
    ...
    string paramfile = "shclass_cmp.par";
    ...
    float epocdur = nutrpat * nstep * timestep;
    ...
    if (inhidtaup>0) inhidprj->setparam(TAUP,inhidtaup); else  inhidprj->setparam(TAUP,kTp*epocdur);
    ...
    /// inhidprj->fwritestate("aWij","inhidwij.bin"); // Causes error
    ...
    if (logselect>0) fwritemat(telbl,"telbl.bin");
